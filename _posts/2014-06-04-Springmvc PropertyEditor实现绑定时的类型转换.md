---
layout: post
title: Springmvc PropertyEditor实现绑定时的类型转换
date: 2014-06-04 01:31
...
```html
EL phoneNumber:${dataBinderTest.phoneNumber.areaCode}-${dataBinderTest.phoneNumber.phoneNumber}<br/>
	EL date:${dataBinderTest.date}<br/>
```

结果：EL phoneNumber:010-12345678
EL date:Sun Mar 18 16:48:48 CST 2012
